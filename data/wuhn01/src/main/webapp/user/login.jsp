		  ...
		  <div class="form-group">
		    	<div class="input-group">
				    <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>  					
		      		<input value="123456" type="password" name="password" class="form-control JV_Required JV_Password" id="inputPassword" placeholder="请输入密码" aria-describedby="basic-addon2">
		      	</div>
		  </div>
		  <div class="form-group">
